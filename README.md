...
| :---: | :--- | ----------- | :------: | :---: | 
| 2 | [Fil de Fer](https://github.com/Akadil/42project_fdf/blob/main/en.subject.pdf) | Create a simple `wireframe model` of a landscape | [Link](https://github.com/Akadil/42project_fdf) | Rigor <br/> Imperative programing <br/> Graphics <br/> Algorithms & AI |
